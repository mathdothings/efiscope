...
final class Request
{
    ...
    public function download(array $keys)
    {
        ...
        if (strpos($contentType, 'application/zip') !== false && filesize($filepath) > 22) {
            echo '<br />';
            echo '<p style="text-align: center; background-color: #F0FDF4; color: #00C951; padding: 0.5rem 1rem; border: 1px solid #B9F8CF; border-radius: 6px;">' . 'Os arquivos foram baixados em: ' . realpath($filepath) . '</p>';
        }
